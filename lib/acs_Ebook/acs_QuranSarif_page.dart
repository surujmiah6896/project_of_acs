...
class ACS_QuranSarif extends StatefulWidget {
  @override
  _ACS_QuranSarifState createState() => _ACS_QuranSarifState();
}

class _ACS_QuranSarifState extends State<ACS_QuranSarif> {
  int selectedCard = -1;
  @override
