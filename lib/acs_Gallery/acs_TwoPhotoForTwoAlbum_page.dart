...
class ACS_TwoPhotoForTwoAlbum extends StatefulWidget {
  final PhotoTwoAlbums photos;

  ACS_TwoPhotoForTwoAlbum({
    required this.photos,
  });

  @override
  _ACS_TwoPhotoForTwoAlbumState createState() =>
      _ACS_TwoPhotoForTwoAlbumState();
}

class _ACS_TwoPhotoForTwoAlbumState extends State<ACS_TwoPhotoForTwoAlbum> {
  @override
